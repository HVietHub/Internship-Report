...
2. User name: `everyonecook-dev`
3. Enable "Provide user access to the AWS Management Console"
4. Attach policies:
   - AdministratorAccess (for workshop, use more restrictive in production)
...
2. Token name: `everyonecook-deploy`
...
![Environment Verification](/images/5-Workshop/5.2-setup-environment/verification-complete.png)
*Screenshot: Terminal showing all tools verified*
