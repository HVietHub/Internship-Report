...
# Hello World Team – Đại học FPT – EveryoneCook

**Ngày:** 30/11/2025

📥 <a href="https://hviethub.github.io/Internship-Report/Proposal.docx" download="Proposal.docx"><strong>Tải Đề Xuất Đầy Đủ (DOCX)</strong></a>
...
![Your profile picture](/images/2-Proposal/Fsocialarchitecture.png)
...
| Frontend Stack + Fix bug, Tester | Tuần 11-12 | Foundation, Authentication, User Profile Management, Privacy Setting Pages, Avatar Upload Component, Recipe Management, AI Recipe Suggestion, Social Feature, Search Discovery, Testing and Fix Bug | Functional profile view page, Login/signup/logout/password reset/security middleware, Profile editing with validation, Avatar upload with S3 integration, Privacy settings interface | 2 tuần |
